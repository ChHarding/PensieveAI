...
def dashboard():
    ...
    st.markdown('<p class="welcome">Unlock the magic within your qualitative data with PensieveAI!<br>Just like a wizard&#39;s Pensieve, this platform reveals hidden themes within your data instantly. Not only that, you get rich excerpts for each theme that bring your findings to life. Add your own instructions to personalize the analysis and create a research experience that&#39;s truly magical."</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
